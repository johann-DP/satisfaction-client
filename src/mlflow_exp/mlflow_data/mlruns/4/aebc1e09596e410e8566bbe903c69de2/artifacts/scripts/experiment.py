...
experiment_name = "Sentiment_Analysis_GBT"
...
# Utilisation de GBTClassifier à la place de LogisticRegression
gbt = GBTClassifier(maxIter=100, maxDepth=5, seed=42)
pipeline = Pipeline(stages=[tokenizer, swr, hashTF, gbt])
...
client = MlflowClient()
model_name = "SentimentAnalysisModel_GBT"
try:
...
with mlflow.start_run(run_name=run_name) as run:
    mlflow.log_params({"maxIter": 100, "maxDepth": 5, "seed": 42})
