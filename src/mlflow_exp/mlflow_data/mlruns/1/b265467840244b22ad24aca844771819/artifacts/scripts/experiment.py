...
train, validation, test = data.randomSplit([0.8, 0.1, 0.1])
...
lr = LogisticRegression(maxIter=350, regParam=0.29, family="multinomial")
...
with mlflow.start_run(run_name=run_name) as run:
    mlflow.log_params({"maxIter": 350, "regParam": 0.29, "family": "multinomial"})
